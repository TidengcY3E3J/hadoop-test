 ...
 */
package com.digitalchina.dcn.hadoop.avro;  
...
public class StringPair extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StringPair\",\"namespace\":\"com.digitalchina.dcn.hadoop.avro\",\"doc\":\"A pair of strings.\",\"fields\":[{\"name\":\"left\",\"type\":\"string\"},{\"name\":\"right\",\"type\":\"string\"}]}");
  ...
  public static com.digitalchina.dcn.hadoop.avro.StringPair.Builder newBuilder() {
    return new com.digitalchina.dcn.hadoop.avro.StringPair.Builder();
  }
  
  /** Creates a new StringPair RecordBuilder by copying an existing Builder */
  public static com.digitalchina.dcn.hadoop.avro.StringPair.Builder newBuilder(com.digitalchina.dcn.hadoop.avro.StringPair.Builder other) {
    return new com.digitalchina.dcn.hadoop.avro.StringPair.Builder(other);
  }
  
  /** Creates a new StringPair RecordBuilder by copying an existing StringPair instance */
  public static com.digitalchina.dcn.hadoop.avro.StringPair.Builder newBuilder(com.digitalchina.dcn.hadoop.avro.StringPair other) {
    return new com.digitalchina.dcn.hadoop.avro.StringPair.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringPair>
    ...
    private Builder() {
      super(com.digitalchina.dcn.hadoop.avro.StringPair.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.digitalchina.dcn.hadoop.avro.StringPair.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing StringPair instance */
    private Builder(com.digitalchina.dcn.hadoop.avro.StringPair other) {
            super(com.digitalchina.dcn.hadoop.avro.StringPair.SCHEMA$);
    ...
    /** Sets the value of the 'left' field */
    public com.digitalchina.dcn.hadoop.avro.StringPair.Builder setLeft(java.lang.CharSequence value) {
    ...
    public com.digitalchina.dcn.hadoop.avro.StringPair.Builder clearLeft() {
      left = null;
    ...
    /** Sets the value of the 'right' field */
    public com.digitalchina.dcn.hadoop.avro.StringPair.Builder setRight(java.lang.CharSequence value) {
    ...
    public com.digitalchina.dcn.hadoop.avro.StringPair.Builder clearRight() {
      right = null;
